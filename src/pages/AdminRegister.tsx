    ...
    <div className="flex-1 flex flex-col justify-center items-center p-8 bg-[#F9F9F7]">
      <div className="w-full max-w-sm bg-white border border-black/10 p-8 shadow-sm">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-3xl font-light font-serif italic tracking-tight mb-2">Host Setup</h1>
          <p className="text-[10px] uppercase tracking-[0.2em] opacity-40 font-bold">Create Account</p>
        </div>
        ...
        <form onSubmit={handleRegister} className="space-y-6">
          ...
          <div className="text-center mt-6 text-sm opacity-60">
            Already have an account? <Link to="/admin/login" className="font-bold underline">Login</Link>
          </div>
        </form>
      </div>
    </div>
